...
Ejemplo de carta dummy:
	...
	El jugador que lanza el color escoge el azul, por ende la carta que se genera en el pozo será --> \_zul\_.txt (Por ende el jugador sólo podrá jugar cartas azules o negras)
